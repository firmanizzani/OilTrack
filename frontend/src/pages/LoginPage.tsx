...
import { Gauge, Mail, Lock, Eye, EyeOff } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = (err as { response?: { data?: { message?: string } } })
        ?.response?.data?.message ?? 'Login gagal. Periksa kembali email & password.';
      setError(msg);
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="card p-6">
          ...
          <p className="text-sm text-muted mb-6">Masuk ke akun OliTrack kamu</p>
